...
body::before {
  content: "";
  background-image: url('../assets/img/ghibli.jpg');
...
/* Make the footer transparent to show the background image */
.footer {
...
/* Add a subtle semi-transparent overlay to make footer text readable */
.footer .container {
    ...
    <div class="hero-body">
      <div class="container">
        <div id="qivd-results-carousel" class="carousel results-carousel">
          ...
          <div class="item">
            <video poster="" autoplay controls muted loop playsinline>
              <source src="../assets/img/qivd/videos/00000465.mp4" type="video/mp4">
            </video>
          </div>
          <div class="item">
            <video poster="" autoplay controls muted loop playsinline>
...
where users ask questions that the system has to answer, in
...
can significantly reduce this gap.
  ...
  <script>
  function sortOfflineTable(n) {
    var table, rows, switching, i, x, y, shouldSwitch, dir, switchcount = 0;
    table = document.getElementById("offline-leaderboard-table");
    switching = true;
    // Set the sorting direction to ascending:
    dir = "asc";
...
<script>
  ...
  var eggRevealed = false;
  var typing = false;
  var message = "this project was released on march 26, 2025 when the internet was taken over with ghibli style images and thus this ghibli-style page.";
  
  function toggleEasterEgg() {
    var easterEggElement = document.getElementById("easter-egg");
    
    if (eggRevealed) {
      // Go back to "Reveal Easter Egg"
      easterEggElement.classList.remove("typing-effect");
      easterEggElement.classList.add("easter-egg");
      easterEggElement.innerHTML = "Easter Egg";
      eggRevealed = false;
    } else {
      // Reveal the Easter egg with typing effect
      easterEggElement.classList.remove("easter-egg");
      easterEggElement.classList.add("typing-effect");
      ...
      function typeWriter() {
        if (i < message.length) {
          easterEggElement.innerHTML += message.charAt(i);
          i++;
